    ...
    >
      <div className='h-full px-4 flex flex-col sm:px-8 md:px-12 lg:px-20 xl:px-48'>
        <div className='h-1/2 p-10 bg-[#FED795] rounded-[3.5rem] flex-col'>
          <div className='nunito-normal text-xl'>SABINA KUTNIAUSKE</div>
          <div className='h-full bungee-shade-regular text-6xl flex justify-center items-center md:text-8xl xl:text-9xl lg:text-9xl'>
            DESIGNER & DEVELOPER
          </div>
        </div>
        <div className='h-1/2 flex flex-row justify-center p-10 gap-8'>
          <div className='w-1/2 flex flex-col gap-8'>
            ...
            <div className=''>
              <Link href='/portfolio'>
                <button className='p-4 rounded-xl bg-[#FB5FFC] text-[#191919] black-shadow w-40'>
                  View My Works
                </button>
              </Link>
            </div>
          ...
          <div className='w-1/2 flex flex-col gap-8'>
            ...
            <div>
              <Link href='/contact'>
                <button className='p-4 rounded-xl bg-[#99D8DA] text-[#191919] w-40 black-shadow'>
                  Contact Me
                </button>
              </Link>
            </div>
